package com.dalila_jose.helpdesk.security;
...
import com.dalila_jose.helpdesk.domain.dtos.CredenciaisDTO;
import com.fasterxml.jackson.databind.ObjectMapper;
 
//intercepta a requisição post no endpoint login(endpoint reservado do spring security)
